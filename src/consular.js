...
export const POA_PURPOSES = {
  ...
  birthRecord: 'مراجعة كافة دوائر وزارة الصحة ومديرية الأحوال المدنية وجميع الدوائر الرسمية ذات العلاقة في {place} لإصدار صورة قيد الولادة الخاصة بي واستلامها وتصديقها من وزارة الخارجية ومراجعة كافة الدوائر المختصة ذات العلاقة، وله الحق بتوكيل الغير نيابة عني، ولأجله وقعت.',
